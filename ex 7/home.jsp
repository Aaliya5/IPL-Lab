...
<%
    ...
    try {
        ...
        while (rs.next()) {
            ...
            out.println("Exam Fee per Subject: " + price + " &emsp;&emsp;&emsp;");
            out.println("<button onclick='AddItem(\"" + id + "\",event,\"" + price + "\")'>ADD STUDENT</button></p>");
        }
        out.println("&emsp;&emsp;<a href='info.html'>View info</a>");
        rs.close();
